export const instructorSidebarNavigation = [
  ...
  { label: "Assignments", icon: "solar:checklist-minimalistic-outline" },
  {
    ...
    children: [
      ...
      { label: "Article Editor", path: "/instructor/articles/create" },
      { label: "Article Preview", path: "/instructor/articles/preview" },
      ...
      { label: "Media Library", path: "/instructor/articles/media" },
    ],
  },
  ...
  { label: "Media Library", icon: "solar:gallery-wide-outline", path: "/instructor/articles/media" },
